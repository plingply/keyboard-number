...
(function (global, factory) {
    ...
    var LocalVariable = /** @class */ (function (_super) {
        ...
        LocalVariable.prototype.getLiteralValueAtPath = function (path) {
    ...
    var Identifier$1 = /** @class */ (function (_super) {
        ...
        Identifier$$1.prototype.getLiteralValueAtPath = function (path) {
            if (this.variable !== null) {
    ...
    var BinaryExpression$1 = /** @class */ (function (_super) {
        ...
        BinaryExpression.prototype.getLiteralValueAtPath = function (path) {
            if (path.length > 0)
                return UNKNOWN_VALUE;
    ...
    var ConditionalExpression$1 = /** @class */ (function (_super) {
        ...
        ConditionalExpression.prototype.getLiteralValueAtPath = function (path) {
            var testValue = this.hasUnknownTestValue ? UNKNOWN_VALUE : this.getTestValue();
    ...
    var Literal$1 = /** @class */ (function (_super) {
        ...
        Literal$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, _options) {
            if (this.value === null) {
                return path.length > 0;
            }
            return path.length > 1;
        };
        Literal$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, _options) {
            return path.length > 0;
        };
    ...
    var LogicalExpression$1 = /** @class */ (function (_super) {
        ...
        LogicalExpression.prototype.getLiteralValueAtPath = function (path) {
            var leftValue = this.hasUnknownLeftValue ? UNKNOWN_VALUE : this.getLeftValue();
            if (leftValue === UNKNOWN_VALUE)
                return UNKNOWN_VALUE;
    ...
    var MemberExpression$1 = /** @class */ (function (_super) {
        ...
        MemberExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path, callOptions, callback, options) {
            ...
            if (this.variable !== null) {
                ...
                this.object.forEachReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey()].concat(path), callOptions, callback, options);
            }
        };
        MemberExpression$$1.prototype.getLiteralValueAtPath = function (path) {
            if (this.variable !== null) {
                return this.variable.getLiteralValueAtPath(path);
            }
            return this.object.getLiteralValueAtPath([this.propertyKey || this.getComputedKey()].concat(path));
        };
        ...
        MemberExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path, options) {
            ...
            return this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey()].concat(path), options);
        };
        MemberExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path, options) {
            if (this.variable !== null) {
                return this.variable.hasEffectsWhenAssignedAtPath(path, options);
            }
            return this.object.hasEffectsWhenAssignedAtPath([this.propertyKey || this.getComputedKey()].concat(path), options);
        };
        MemberExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path, callOptions, options) {
            ...
            return this.object.hasEffectsWhenCalledAtPath([this.propertyKey || this.getComputedKey()].concat(path), callOptions, options);
        };
        ...
        MemberExpression$$1.prototype.reassignPath = function (path, options) {
            ...
            if (this.variable) {
                ...
                this.object.reassignPath([this.propertyKey || this.getComputedKey()].concat(path), options);
            }
        };
        ...
        MemberExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path, callOptions, predicateFunction, options) {
            ...
            return this.object.someReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey()].concat(path), callOptions, predicateFunction, options);
        };
    ...
    var ObjectExpression$1 = /** @class */ (function (_super) {
        ...
        ObjectExpression$$1.prototype.getLiteralValueAtPath = function (path) {
            if (path.length === 0)
                return UNKNOWN_VALUE;
            var _a = this.getPossiblePropertiesWithName(path[0], PROPERTY_KINDS_READ), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
    ...
    var Property$1 = /** @class */ (function (_super) {
        ...
        Property$$1.prototype.getLiteralValueAtPath = function (path) {
            if (this.kind === 'get') {
                return UNKNOWN_VALUE;
            }
    ...
    var SequenceExpression$1 = /** @class */ (function (_super) {
        ...
        SequenceExpression.prototype.getLiteralValueAtPath = function (path) {
    ...
    var UnaryExpression$1 = /** @class */ (function (_super) {
        ...
        UnaryExpression.prototype.getLiteralValueAtPath = function (path) {
            if (path.length > 0)
                return UNKNOWN_VALUE;
