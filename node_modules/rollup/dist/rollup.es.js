/*
	Rollup.js v0.59.0
	Tue, 15 May 2018 06:03:29 GMT - commit 60653880da906482f4a5b2874560e1cf2b7b0cf0
...
var Variable = /** @class */ (function () {
    ...
    Variable.prototype.getLiteralValueAtPath = function (_path) {
...
var LocalVariable = /** @class */ (function (_super) {
    ...
    LocalVariable.prototype.getLiteralValueAtPath = function (path$$1) {
        if (!this.init || this.reassignments.isPathReassigned(path$$1)) {
            return UNKNOWN_VALUE;
        }
        return this.init.getLiteralValueAtPath(path$$1);
    };
...
var NodeBase = /** @class */ (function () {
    ...
    NodeBase.prototype.getLiteralValueAtPath = function (_path) {
        return UNKNOWN_VALUE;
    };
...
var Identifier$1 = /** @class */ (function (_super) {
    ...
    Identifier$$1.prototype.getLiteralValueAtPath = function (path$$1) {
        if (this.variable !== null) {
            return this.variable.getLiteralValueAtPath(path$$1);
        }
        return UNKNOWN_VALUE;
    };
...
var BinaryExpression$1 = /** @class */ (function (_super) {
    ...
    BinaryExpression.prototype.getLiteralValueAtPath = function (path$$1) {
        if (path$$1.length > 0)
            return UNKNOWN_VALUE;
        var leftValue = this.left.getLiteralValueAtPath(EMPTY_PATH);
        if (leftValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        var rightValue = this.right.getLiteralValueAtPath(EMPTY_PATH);
...
var ConditionalExpression$1 = /** @class */ (function (_super) {
    ...
    ConditionalExpression.prototype.getLiteralValueAtPath = function (path$$1) {
        var testValue = this.hasUnknownTestValue ? UNKNOWN_VALUE : this.getTestValue();
        if (testValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        return testValue
            ? this.consequent.getLiteralValueAtPath(path$$1)
            : this.alternate.getLiteralValueAtPath(path$$1);
    };
    ...
    ConditionalExpression.prototype.getTestValue = function () {
        if (this.hasUnknownTestValue)
            return UNKNOWN_VALUE;
        var value = this.test.getLiteralValueAtPath(EMPTY_PATH);
...
var Literal$1 = /** @class */ (function (_super) {
    ...
    Literal$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, _options) {
        if (this.value === null) {
            return path$$1.length > 0;
        }
        return path$$1.length > 1;
    };
    Literal$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, _options) {
        return path$$1.length > 0;
    };
...
var LogicalExpression$1 = /** @class */ (function (_super) {
    ...
    LogicalExpression.prototype.getLiteralValueAtPath = function (path$$1) {
        var leftValue = this.hasUnknownLeftValue ? UNKNOWN_VALUE : this.getLeftValue();
        if (leftValue === UNKNOWN_VALUE)
            return UNKNOWN_VALUE;
        if (this.isOrExpression ? leftValue : !leftValue)
            return leftValue;
        return this.right.getLiteralValueAtPath(path$$1);
    };
    ...
    LogicalExpression.prototype.getLeftValue = function () {
        if (this.hasUnknownLeftValue)
            return UNKNOWN_VALUE;
        var value = this.left.getLiteralValueAtPath(EMPTY_PATH);
        if (value === UNKNOWN_VALUE) {
...
var MemberExpression$1 = /** @class */ (function (_super) {
    ...
    MemberExpression$$1.prototype.forEachReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, callback, options) {
        ...
        if (this.variable !== null) {
            ...
            this.object.forEachReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey()].concat(path$$1), callOptions, callback, options);
        }
    };
    MemberExpression$$1.prototype.getLiteralValueAtPath = function (path$$1) {
        if (this.variable !== null) {
            return this.variable.getLiteralValueAtPath(path$$1);
        }
        return this.object.getLiteralValueAtPath([this.propertyKey || this.getComputedKey()].concat(path$$1));
    };
    MemberExpression$$1.prototype.hasEffects = function (options) {
        return (this.property.hasEffects(options) ||
            ...
            (this.arePropertyReadSideEffectsChecked &&
                this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey()], options)));
    };
    MemberExpression$$1.prototype.hasEffectsWhenAccessedAtPath = function (path$$1, options) {
        ...
        return this.object.hasEffectsWhenAccessedAtPath([this.propertyKey || this.getComputedKey()].concat(path$$1), options);
    };
    MemberExpression$$1.prototype.hasEffectsWhenAssignedAtPath = function (path$$1, options) {
        ...
        return this.object.hasEffectsWhenAssignedAtPath([this.propertyKey || this.getComputedKey()].concat(path$$1), options);
    };
    MemberExpression$$1.prototype.hasEffectsWhenCalledAtPath = function (path$$1, callOptions, options) {
        ...
        return this.object.hasEffectsWhenCalledAtPath([this.propertyKey || this.getComputedKey()].concat(path$$1), callOptions, options);
    };
    ...
    MemberExpression$$1.prototype.reassignPath = function (path$$1, options) {
        ...
        if (this.variable) {
            ...
            this.object.reassignPath([this.propertyKey || this.getComputedKey()].concat(path$$1), options);
        }
    };
    ...
    MemberExpression$$1.prototype.someReturnExpressionWhenCalledAtPath = function (path$$1, callOptions, predicateFunction, options) {
        ...
        return this.object.someReturnExpressionWhenCalledAtPath([this.propertyKey || this.getComputedKey()].concat(path$$1), callOptions, predicateFunction, options);
    };
    ...
    MemberExpression$$1.prototype.getComputedKey = function () {
        var value = this.property.getLiteralValueAtPath(EMPTY_PATH);
...
var ObjectExpression$1 = /** @class */ (function (_super) {
    ...
    ObjectExpression$$1.prototype.getLiteralValueAtPath = function (path$$1) {
        if (path$$1.length === 0)
            return UNKNOWN_VALUE;
        var _a = this.getPossiblePropertiesWithName(path$$1[0], PROPERTY_KINDS_READ), properties = _a.properties, hasCertainHit = _a.hasCertainHit;
        if (!hasCertainHit || properties.length > 1)
            return UNKNOWN_VALUE;
        return properties[0].getLiteralValueAtPath(path$$1.slice(1));
    };
    ...
    ObjectExpression$$1.prototype.getPossiblePropertiesWithName = function (name, kinds) {
        if (name === UNKNOWN_KEY) {
        ...
        for (var index = this.properties.length - 1; index >= 0; index--) {
            ...
            if (property.computed) {
                var value = property.key.getLiteralValueAtPath(EMPTY_PATH);
...
var Property$1 = /** @class */ (function (_super) {
    ...
    Property$$1.prototype.getLiteralValueAtPath = function (path$$1) {
        if (this.kind === 'get') {
            return UNKNOWN_VALUE;
        }
        return this.value.getLiteralValueAtPath(path$$1);
    };
...
var SequenceExpression$1 = /** @class */ (function (_super) {
    ...
    SequenceExpression.prototype.getLiteralValueAtPath = function (path$$1) {
        return this.expressions[this.expressions.length - 1].getLiteralValueAtPath(path$$1);
    };
...
var UnaryExpression$1 = /** @class */ (function (_super) {
    ...
    UnaryExpression.prototype.getLiteralValueAtPath = function (path$$1) {
        if (path$$1.length > 0)
            return UNKNOWN_VALUE;
        var argumentValue = this.argument.getLiteralValueAtPath(EMPTY_PATH);
